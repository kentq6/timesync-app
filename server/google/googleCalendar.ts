...
import { endOfDay, isFriday, isMonday, isSaturday, isSunday, isThursday, isTuesday, isWednesday, setHours, setMinutes, startOfDay } from "date-fns";
...
export async function getCalendarEventTimes(
  ...
  try {
    ...
    return (
      ...
      // Filder out any undefined results and enfore correct typing
